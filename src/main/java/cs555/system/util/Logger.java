...
/**
 * Generic class to print out debug, info, and error log messages. The class is
 * implemented as a singleton in order to save memory, as many classes will use
 * it. I didn't implement this in my last assignment because I didn't think to
 * do it, and didn't have the patience. I mostly took this class from an
 * implementation by Jason Stock on his GitHub for the same project.
 *
 * @author stock
 * @author hayne
 */
public class Logger {
  ...
  public void debug(String message) {
    if (ApplicationProperties.logLevel.equals("info")) {
      return;
    }
